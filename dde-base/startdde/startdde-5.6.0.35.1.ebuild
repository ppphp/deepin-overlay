...
SRC_URI="https://github.com/linuxdeepin/${PN}/archive/22420cdd33033b0a49a9fbc0f33cc3a7f13315d9.tar.gz -> ${P}.tar.gz
		${EGO_VENDOR_URI}"
...
src_unpack () {
	...
	mv $WORKDIR/{startdde-22420cdd33033b0a49a9fbc0f33cc3a7f13315d9,startdde-5.6.0.35.1/src/pkg.deepin.io/dde/startdde}
